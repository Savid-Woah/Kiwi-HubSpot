...
public class AuthController {
    ...
    public Response registerStore(@Validated @RequestBody RegisterStoreRequest registerStoreRequest) {
    ...
    public Response registerCustomer(@Validated @RequestBody RegisterCustomerRequest registerCustomerRequest) {
